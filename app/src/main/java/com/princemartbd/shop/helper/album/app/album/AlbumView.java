...
import com.princemartbd.shop.helper.album.impl.DoubleClickWrapper;
import com.princemartbd.shop.helper.album.util.AlbumUtils;
import com.princemartbd.shop.helper.album.util.SystemBar;
import com.princemartbd.shop.helper.album.widget.ColorProgressBar;
import com.princemartbd.shop.helper.album.widget.divider.Api21ItemDivider;
...
class AlbumView extends Contract.AlbumView implements View.OnClickListener {
    ...
    public void setupViews(Widget widget, int column, boolean hasCamera, int choiceMode) {
        ...
        int dividerSize = getResources().getDimensionPixelSize(R.dimen._4ssp);
