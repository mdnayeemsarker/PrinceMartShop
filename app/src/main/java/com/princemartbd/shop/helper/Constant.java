...
//    public static final String WebSiteUrl = "https://shop.princemartbd.com/";
    ...
    public static final String APP_UPDATE_URL = MainBaseUrl + "apps.php";
    ...
    //*************************************************************************************
    //AAMRAPAY Live
//    public static final String AAMRAPAY_STORE_ID = "princemartbd";  // need to change with aamrapay live store id
//    public static final String AAMRAPAY_SIGNATURE_KEY = "02d7e06c080b7f4fd9ba4fb63cc573a1";   // need to change with aamrapay live Signature Key
//    public static final Boolean TEST_MODE = false;   // need to change with aamrapay live Signature Key
    //AAMRAPAY SanBox
    public static final String AAMRAPAY_STORE_ID = "aamarpaytest";  // need to change with aamrapay test store id
    public static final String AAMRAPAY_SIGNATURE_KEY = "dbb74894e82415a2f7ff0ec3a97e4183";   // need to change with aamrapay live Signature Key
    public static final Boolean TEST_MODE = true;   // need to change with aamrapay live Signature Key
    ...
    //**********APIS**********
    public static final String ADD_REFERRER = " https://admin.princemartbd.com/api-firebase/user-registration.php";

    public static final String FAQ_URL = BaseUrl + "get-faqs.php";
    public static final String GET_CASHBACKS_URL = BaseUrl + "get-cashbacks.php";
    ...
    public static final String GET_PAY_REQUEST_URL = BaseUrl + "pay-requests.php";
    ...
    public static final String SMS_SEND_URL = BaseUrl + "sms.php";
    ...
    //**************parameters***************
    public static final String GET_CASHBACKS = "get_cashbacks";
    ...
    public static final String SELLER_SLUG = "seller_slug";
    ...
    public static final String ABMN_QR_RESULT = "abmn_qrResult";
    public static final String TYPE_AMOUNT = "TYPE_AMOUNT";
    public static final String SEND_SMS = "send_sms";
    public static final String TEXT = "text";
    public static final String GENERATED_OTP = "generateOTP";
    ...
    public static String GET_HISTORIES = "get_histories";
    ...
    public static String SSLECOMMERZ_MODE = "sandbox";
    public static String SSLECOMMERZ_STORE_ID = "amrap61b7952fcc3d2"; //
    public static String SSLECOMMERZ_SECRET_KEY = "amrap61b7952fcc3d2@ssl"; //
